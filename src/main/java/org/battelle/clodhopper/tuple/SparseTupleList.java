 ...
 *
 */
public interface SparseTupleList {
     ...
     * getTupleLength().
     */
    void setTuple(int n, TIntDoubleMap values);
    ...
    /**
     * Returns from a sparse matrix the length of a given tuple.
     * @param n
     * @return
     */
    int getTupleFeatureLength(int n);
}
