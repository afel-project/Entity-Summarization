...
import org.battelle.clodhopper.kmeans.SparseKMeansSplittingClusterer;
...
public class SparseXMeansClusterer extends SparseKMeansSplittingClusterer implements Clusterer {

    private double overallBIC;

    public SparseXMeansClusterer(SparseTupleList tuples, SparseXMeansParams params) {
        super(tuples, params);
    }
    ...
    protected ClusterSplitter createSplitter(List<Cluster> clusters, Cluster cluster) {
        return new SparseXMeansClusterSplitter(tuples, clusters, overallBIC, (SparseXMeansParams) params);
    }
