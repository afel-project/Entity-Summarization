...
public class SparseXMeansClusterSplitter extends AbstractClusterSplitter {
    ...
    public SparseXMeansClusterSplitter(SparseTupleList tuples, List<Cluster> clusters, double overallBIC, SparseXMeansParams params) {
