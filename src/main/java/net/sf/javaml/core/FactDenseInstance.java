 ...
 * 
 */
public class FactDenseInstance extends AbstractInstance implements Instance {
     ...
     */
    public FactDenseInstance(double[] att) {
        this(att, null);
    }
     ...
     *            the class label
     */
    public FactDenseInstance(double[] att, Object classValue) {
        super(classValue);
        this.attributes = att.clone();
    }
    public FactDenseInstance(String[] prop, double[] att, Object classValue) {
        super(classValue);
        this.attributes = att.clone();
        this.properties = prop.clone();
        System.out.print("");
    }
    ...
    public String getPropertyString(){
        ...
        for(int i=0; i < this.properties.length; i++)
            res = res + this.properties[i]+"\t";
        return res;
    }
    public String compose_json_str(){
        String [] pred = properties[2].split("/");

        String res="\t\t{\n";
        res += "\t\t\t\"predicate\": \""+pred[pred.length-1]+"\",\n";
        res += "\t\t\t\"object\": \""+properties[3]+"\"\n";
     ...
     */
    public FactDenseInstance(int size) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final FactDenseInstance other = (FactDenseInstance) obj;
    ...
    public Instance copy() {
        FactDenseInstance out = new FactDenseInstance();
